...
function PayIconRes(props) {
  ...
  const handlePay = async () => {
    // await fetch('http://localhost:5001/itracker-development/us-central1/itrackerPaymentFunction/create-payment-intent-res', {
    await fetch('https://us-central1-itracker-development.cloudfunctions.net/itrackerPaymentFunction/create-payment-intent-res', {
...
export default connect(mapStateToProps, mapDispatchToProps)(PayIconRes);
