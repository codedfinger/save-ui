...
import { addToShoppingListRes } from "../../../../../../store/actions/marketplaceActions/restaurantData";
...
const AddMealFormShop = (props) => {
  ...
  const handleSubmit = () => {
    ...
    props.addToShoppingListRes(data);
...
const mapDispatchToProps = (dispatch) => {
  return {
    addToShoppingListRes: (data) => dispatch(addToShoppingListRes(data)),
  };
};
